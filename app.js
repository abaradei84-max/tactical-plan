...
function initFilters(){
  ...
  FILTERS.forEach(([key,label])=>{
    ...
    box.querySelector('[data-a="all"]').addEventListener('click',()=>{const vals=[...box.querySelectorAll('.check')].map(x=>x.dataset.value);selections[key]=new Set([...selections[key],...vals]);updateAll()});
